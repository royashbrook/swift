...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func update(currentTime: CFTimeInterval) {
        ...
        if (!heroOnScreen()) {
            ...
            // update the score
            self.score++
            scoreLabel.text = "Current: " + String(self.score)
            if self.score > self.highScore {
                highScoreLabel.text = "High: " + String(self.score)
            }
        }
    ...
    func setupEverything(){
        ...
        NSLog(String(stringInterpolationSegment: highScoreDefault.valueForKey("HighScore") != nil))
        NSLog(String(self.highScore))
    ...
    func spawnPipes(pipeTexture:SKTexture,pipesMoveAndRemove:SKAction){
        ...
        //const
        let pipeGap = Int.random(170...340)
